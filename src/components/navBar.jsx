          ...
          >
            <ul class="navbar-nav mr-auto" hidden={!user}>
              ...
              <li class="nav-item active" hidden={!user?.isAdmin}>
                <Link class="nav-link text-white" to="/admin">
                  Admin
                </Link>
              </li>

              <li class="nav-item active">
                <Link class="nav-link text-white" to="/login" onClick={handleLogout}>
                  logout
                </Link>
              </li>

              <li class="nav-item" hidden={!user} style={{ position: 'absolute', right: 20}}>
